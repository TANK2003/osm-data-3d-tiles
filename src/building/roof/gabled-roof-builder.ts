...
import HippedRoofBuilder from "./hipped-roof-builder.js";
import { RoofSkirt, RoofSkirtPolyline } from "./type.js";
import { getIntersectionLineLine } from "./utils.js";
            ...
            if (polygon.vertices.length === 3) {
                ...
                if (prevPolygon.vertices.length > 3 && nextPolygon.vertices.length > 3) {
                    ...
                    if (otherPoint) {
                        ...
                        const center = getIntersectionLineLine(
                            [begin.x, begin.y],
                            [end.x, end.y],
                            [b.x, b.y],
                            [t.x, t.y]
            ...
            points: [
                {
                    ...
                    position: edgeCenter,
                    height: minHeight + centerHeight * height
                }, {
                    position: edgeEnd,
                    height: minHeight
                }
